...
class ConsultarHorariosView {
    ...
    renderizarHorarios() {
        ...
        if (horariosVisibles.length === 0) {
            ...
            contenedor.innerHTML = `
                <p class="mensaje-vacio">${mensaje}</p>
                <p style="text-align:center;margin-top:20px">
                    <a href="AsignarHorario.html" style="
                        display:inline-block;padding:10px 18px;background:#0056b3;color:#fff;
                        text-decoration:none;border-radius:6px;font-weight:600;
                    ">Ir a Asignar Horario</a>
                </p>`;
            return;
        }
